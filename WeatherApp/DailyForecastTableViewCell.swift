...
class DailyForecastTableViewCell: UITableViewCell {
    ...
    private func setHierarchy(){
        ...
        NSLayoutConstraint.activate([
            weekDayLabel.widthAnchor.constraint(lessThanOrEqualToConstant: 50) //Definindo o tamanho maximo lateral
        ])
    }
    
    //Outra maneira é coloando as constranits em outro lugar, e dpois apenas chama-las por uma extensao (UIView + Extensions
